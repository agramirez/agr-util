/** 
  ...
  @description This module contains a bunch of useful functions for doing
...
var _debug = false, 
    _dlogger = {
      ...
      vals: function (data) { 
        if (_debug) {
          for(var v in data) { 
            console.log(data[v].name + ' = ' + data[v].value);
          }
        }
      },
      log: function (msg) {
