...
/**
  Creates a new object with the properties of the first param.  The
  values of the properties are set to the values found in the second
  param if they exist.

  @param template Object to be used as a template.  The result from the
                  function contains the same properties as this object.
  @param values Object with the new values to override the defaults in
                the template object.
  
  @returns New object with the properties specfified in the first param
           and the values, if any, from the second param.  Returns an 
           empty object if the template is null.
*/
