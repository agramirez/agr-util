...
exports.isNullOrEmpty = {
  ...
  'no args': function (test) {
    ...
    var expected = true, actual = util.isNullOrEmpty();
  ...
  'null object': function (test) {
    ...
    var data = null, expected = true, actual = util.isNullOrEmpty(data);
  ...
  'undefined value': function (test) {
    ...
    var data, expected = true, actual = util.isNullOrEmpty(data);
  ...
  'string with 5 whitespaces and no characters': function (test) {
    ...
    var data = '     ', 
        expected = false, 
        actual = util.isNullOrEmpty(data);
