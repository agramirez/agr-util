...
exports.isNullOrWhitespace = {
  ...
  'no args': function (test) {
    ...
    var expected = true, actual = util.isNullOrWhitespace();
  ...
  'null object': function (test) {
    ...
    var data = null, expected = true, actual = util.isNullOrWhitespace(data);
  ...
  'undefined value': function (test) {
    ...
    var data, expected = true, actual = util.isNullOrWhitespace(data);
  ...
  'string with 5 whitespaces and no characters': function (test) {
    ...
    var data = '     ', 
        expected = true, 
        actual = util.isNullOrWhitespace(data);
